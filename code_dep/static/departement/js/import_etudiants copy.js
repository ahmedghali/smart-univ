// Dans votre fichier static/departement/js/import_etudiants.js
...
$(document).ready(function() {
    ...
    nivsSelect.on('change', function() {
        ...
        console.log('🔍 IMPORT DEBUG: niveauId =', niveauId, ', reformeId =', reformeId);
        ...
        if (niveauId && reformeId) { // CORRECTION: Vérifier aussi reforme_id
            $.ajax({
                ...
                success: function(response) {
                    console.log('🔍 IMPORT DEBUG groupes reçus:', response.data);
